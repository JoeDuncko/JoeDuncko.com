...
Through my work as an Entrepreneur in Residence at the Youngstown Business Incubator, I get a lot of questions about building MVPs. This blog post is my attempt to capture as much as the advice I typically give in one place.
...
You may not need an MVP to prove your startups next largest risk.

### MVPs are expensive and inherently risky

Because you don't want to waste resources building the wrong thing, if you can help it

As such, make it your goal to learn as much as you can BEFORE you start building an MVP.
...
It's not too late to look at the estimate and cut parts that are not necessary to achieve the goals your MVP goals.
