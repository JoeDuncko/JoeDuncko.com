...
To avoid wasting time and resources on building the wrong thing, make it your goal to learn as much as you can BEFORE you start building an MVP.
...
At any point, if you don't feel like you are learning, you should probably try something different.
...
Goal: Have a visual reference that allows everyone involved to make sure they are on the same page (ie, agree on scope)
...
<figure>
  ...
  <figcaption>
    ...
    excellent article that illustrates the different fidelities of wireframes.
  </figcaption>
</figure>
...
- Web: React via Vite, MUI components
- Mobile Apps: React Native via Expo, GlueStack components
...
It is important that your app implementation is stateless - all state should be stored in a database, so that worker services (whether microservice based or monolith based doesn't matter) can be spun up and down on demand - not only to scale horizontally, but to quickly recover from bad states. Not doing so will lead to regrets down the line.

Use the ["Twelve Factor App"](https://12factor.net/) as a guideline.
...
<figure>
  ...
  <figcaption>
    Image from
    [this](https://github.com/SvanBoxel/release-based-workflow/issues/1) GitHub
    repository.
  </figcaption>
</figure>
...
<figure>
  ...
  />
  <figcaption>
    Image from [this](https://www.nvisia.com/insights/agile-methodology) article
    that illustrates the Agile Methodology.
  </figcaption>
</figure>
