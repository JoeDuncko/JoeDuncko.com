...
excerpt: "Why I'm not using GitHub Classroom for teaching my first class."
date: 2022-09-05
---
...
The GitHub Classroom quirks are also visible from the instructor side. For example, currently the "Submitted" status on an assignment means that a commit was been pushed up and the due date for the assignment has passed.
...
- Allow instructors to select what the definition of "Submitted" is. The option I'd like is if a student has main a PR and selected a teacher to review it.
